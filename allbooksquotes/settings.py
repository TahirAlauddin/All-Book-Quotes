"""
Django settings for allbooksquotes project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY',
                            'django-insecure-rdkg%x83sd#rdx104l9nty83qf=q^l&%b9hl+=z0+$esm9!pvq')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '143.110.248.192', 'allbooksquotes.com']
...
ROOT_URLCONF = 'allbooksquotes.urls'
...
WSGI_APPLICATION = 'allbooksquotes.wsgi.application'
...
AUTH_USER_MODEL = 'users.BooksQuotesUser'
